...
struct Arm {
    ...
    Arm(string op, string rs = "", string a1 = "", string a2 = "",
        string add = "");
    void replace(string op, string rs = "", string a1 = "", string a2 = "",
                 string add = "");
    void setDead();   //设置无效
    string outPut();  //输出函数
};
...
class ILoc {
   ...
   public:
    ...
    //基址寻址 str r0,[fp,#100]
    void str_base(string srcReg, string base, int disp, string tmpReg,
                  bool isChar);
    /*
            label 注释 一般指令
    */
    ...
    */
    ...
    /*
            函数调用
    */
    void call_lib(string fun, string rsReg, string reg1,
                  string reg2);              //调用库函数
    ...
    */
    ...
    void cmp(string cmp, string cmpnot, string rsReg, string reg1,
             string reg2);  //比较
    /*
